...
//   return (
//     <div>
//       <div className="w-[173px] h-[218px] flex flex-col justify-center items-center bg-[#FFFFFF]  rounded-2xl border-1 border-[#8B19A4] mx-3">
//         <div
//           className="w-1/2 h-[70%] object-cover"
//           style={{
//             background: `url("../../../media/whisper.svg")`,
//             backgroundPosition: "center",
//             backgroundRepeat: "no-repeat",
//           }}
//         ></div>

//         <div className="w-[100%] h-[30%] p-4 flex flex-col gap-2">
//           <p className="font-poppin font-medium text-sm leading-4 ">
//             Always ultra thin
//           </p>
//           <div className="flex justify-between ">
//             <p className="font-poppin font-medium text-sm leading-4">₹ 550</p>
...
const ProductCard = ({ product }) => {
  return (
    <div className="w-[173px] h-[218px] flex flex-col justify-center items-center bg-[#FFFFFF] rounded-2xl border border-[#8B19A4] mx-3">
      {/* Image */}
      <div
        className="w-1/2 h-[70%] object-cover"
        style={{
